...
def build_agent_prompt(
    ...
    return (
        ...
        "Use the configured Codex Git commit identity `Codex <codex@openai.com>` "
        "for agent commits; do not set commit authorship to a specific student "
        ...
        "StudyOS team updates without adding extra runtime attribution trailers.\n"
